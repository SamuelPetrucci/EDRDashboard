...
const FEED = [
  ...
  { who: 'Michael Brown', role: 'Field User', action: 'Uploaded documents for Health domain', when: '1 hour ago' },
...
export default function AdminControlTower() {
  return (
    <div className="dris-dashboard dris-dashboard--admin">
      <h1 className="dris-dashboard__page-title">Country administrator control tower</h1>
